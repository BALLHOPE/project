...
<body>
    <main>
        <?php if ($tst['ui'] == "light") : ?>
            <!-- สีพื้นหลัง -->
            <div class="bg-cover" style="background-image: linear-gradient(to left, white, transparent 0%),linear-gradient(to top, white, transparent 0%),url(<?= $config['bg2'] ?>);"></div>   
        <?php endif ?>
        <?php if ($tst['ui'] == "dark") : ?>
        ...
        <?php endif ?>
            ...
            <div class="bg-80-center">
                <center data-aos="fade-up" id="img-load" class="aos-init aos-animate" style="margin-top: 0px; transform: scale(1);">
                    <div><img src="assets/icon/เทเล.png" class="float-ani" width="300"></div>
                </center>
                <div>
                    <center class="letter" style="opacity: 1; transform: translateY(0px) translateZ(0px);">
                    <h1 style="font-size: 50px; color: white;" class="text-font text-strongest aos-init aos-animate" data-aos="fade-up" data-aos-delay="2200" data-aos-duration="800">กากเกรียนเรนเจอร์</h1>
